...
bravo = Restaurant('bravo', 'kuchnia włoska')
szarpane = Restaurant('szarpane', 'burgery')
miś = Restaurant('Miś', 'bar mleczny')

bravo.describe_restaurant()
szarpane.describe_restaurant()
miś.describe_restaurant()