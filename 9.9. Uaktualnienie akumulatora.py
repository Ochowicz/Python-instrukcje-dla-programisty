...
class Battery():
    ...
    def describe_battery(self):
        ...
        print(f"Ten samochód ma akumulator o pojemności "
    ...
    def get_range(self):
        ...
        print(f"Zasięg tego samochodu wynosi około {range} km "
              f"po pełnym naładowaniu akumulatora.")
    def upgrade_battery(self):
        if self.battery_size != 100:
            self.battery_size = 100
            print('Bateria została zwiększona do 100 kWh.')
        elif self.battery_size == 100:
            print('Bateria ma już pojemność 100 kWh.')
